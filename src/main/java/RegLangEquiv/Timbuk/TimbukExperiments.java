...
public class TimbukExperiments {
    private static final String path = "/Users/giovbacci/Library/CloudStorage/OneDrive-AalborgUniversitet/AAU/Research/Tools/Dependecies/Experiments/Timbuk/random_difficult_cases/";
    ...
    private static void testHKCEquiv(String nfaL, String nfaR) {
        String[] arguments = new String[] {"/Users/giovbacci/Library/CloudStorage/OneDrive-AalborgUniversitet/AAU/Research/Tools/hknt-1.0/hkc", "-equiv",
                path+nfaL, path+nfaR};
        try {
    ...
    private static void testHKCInclusion(String nfaL, String nfaR) {
        String[] arguments = new String[] {"/Users/giovbacci/Library/CloudStorage/OneDrive-AalborgUniversitet/AAU/Research/Tools/hknt-1.0/hkc", "-incl",
                path+nfaL, path+nfaR};
        try {
            ProcessBuilder pb = new ProcessBuilder(arguments);
            //pb.redirectOutput(ProcessBuilder.Redirect.PIPE);
