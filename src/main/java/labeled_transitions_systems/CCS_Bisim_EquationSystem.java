...
public class CCS_Bisim_EquationSystem extends BDDRelEquationSystem<Boolean> {
    ...
    public CCS_Bisim_EquationSystem(String modelCode, boolean strong, boolean fileFlag){
    ...
    private BoolFormula simulation(Set<CCSProcess.CCS_Step> succS, Set<CCSProcess.CCS_Step> succT){
        ...
        for (CCSProcess.CCS_Step stepS : succS) {
            ...
            subFormulaAND.add(
                    new BoolFormula.And(subFormulaOR,CCS_Bisim_EquationSystem.this)
            );
        }
        return new BoolFormula.Or(subFormulaAND,CCS_Bisim_EquationSystem.this);
    }
